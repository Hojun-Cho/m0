...
#define JIO_8_RO_RD(name, ...)          (*(const volatile u8int *)(JA_##name))
...
#define JIO_8_RO_VAR(name, ...)         (*(const volatile u8int *)(JA_##name))

#define JIO_16_RO(op, name, ...)        JIO_16_RO_##op(name, __VA_ARGS__)
#define JIO_16_RO_RD(name, ...)         (*(const volatile u16int *)(JA_##name))
...
#define JIO_16_RO_VAR(name, ...)        (*(const volatile u16int *)(JA_##name))

#define JIO_32_RO(op, name, ...)        JIO_32_RO_##op(name, __VA_ARGS__)
#define JIO_32_RO_RD(name, ...)         (*(const volatile u32int *)(JA_##name))
 ...
 *          jz_writef(ICOLL_ENABLE(3), CPU0_PRIO(1), CPU0YPE_V(FIQ))
 */
 ...
 *          jz_overwritef(ICOLL_ENABLE(3), CPU0_PRIO(1), CPU0YPE_V(FIQ))
 */
 ...
 *          jz_vwritef(var, ICOLL_ENABLE, CPU0_PRIO(1), CPU0YPE_V(FIQ))
 */
 ...
 *          jz_setf(ICOLL_ENABLE(3), CPU0_PRIO, CPU0YPE)
 */
 ...
 *          jz_clrf(ICOLL_ENABLE(3), CPU0_PRIO, CPU0YPE)
 */
 ...
 *          jz_csf(ICOLL_ENABLE(3), CPU0_PRIO(1), CPU0YPE_V(FIQ))
 */
...
#define BP_CPM_USBPCRXFSLSTUNE                    7
#define BM_CPM_USBPCRXFSLSTUNE                    0x780
#define BF_CPM_USBPCRXFSLSTUNE(v)                 (((v) & 0xf) << 7)
#define BFM_CPM_USBPCRXFSLSTUNE(v)                BM_CPM_USBPCRXFSLSTUNE
#define BF_CPM_USBPCRXFSLSTUNE_V(e)               BF_CPM_USBPCRXFSLSTUNE(BV_CPM_USBPCRXFSLSTUNE__##e)
#define BFM_CPM_USBPCRXFSLSTUNE_V(v)              BM_CPM_USBPCRXFSLSTUNE
#define BP_CPM_USBPCRXHSXVTUNE                    4
#define BM_CPM_USBPCRXHSXVTUNE                    0x30
#define BF_CPM_USBPCRXHSXVTUNE(v)                 (((v) & 0x3) << 4)
#define BFM_CPM_USBPCRXHSXVTUNE(v)                BM_CPM_USBPCRXHSXVTUNE
#define BF_CPM_USBPCRXHSXVTUNE_V(e)               BF_CPM_USBPCRXHSXVTUNE(BV_CPM_USBPCRXHSXVTUNE__##e)
#define BFM_CPM_USBPCRXHSXVTUNE_V(v)              BM_CPM_USBPCRXHSXVTUNE
#define BP_CPM_USBPCRXVREFTUNE                    0
#define BM_CPM_USBPCRXVREFTUNE                    0xf
#define BF_CPM_USBPCRXVREFTUNE(v)                 (((v) & 0xf) << 0)
#define BFM_CPM_USBPCRXVREFTUNE(v)                BM_CPM_USBPCRXVREFTUNE
#define BF_CPM_USBPCRXVREFTUNE_V(e)               BF_CPM_USBPCRXVREFTUNE(BV_CPM_USBPCRXVREFTUNE__##e)
#define BFM_CPM_USBPCRXVREFTUNE_V(v)              BM_CPM_USBPCRXVREFTUNE
...
#define BP_CPM_USBPCRXRISETUNE                    26
#define BM_CPM_USBPCRXRISETUNE                    0x4000000
#define BF_CPM_USBPCRXRISETUNE(v)                 (((v) & 0x1) << 26)
#define BFM_CPM_USBPCRXRISETUNE(v)                BM_CPM_USBPCRXRISETUNE
#define BF_CPM_USBPCRXRISETUNE_V(e)               BF_CPM_USBPCRXRISETUNE(BV_CPM_USBPCRXRISETUNE__##e)
#define BFM_CPM_USBPCRXRISETUNE_V(v)              BM_CPM_USBPCRXRISETUNE
...
#define BP_CPM_USBPCRXPREEMPHTUNE                 6
#define BM_CPM_USBPCRXPREEMPHTUNE                 0x40
#define BF_CPM_USBPCRXPREEMPHTUNE(v)              (((v) & 0x1) << 6)
#define BFM_CPM_USBPCRXPREEMPHTUNE(v)             BM_CPM_USBPCRXPREEMPHTUNE
#define BF_CPM_USBPCRXPREEMPHTUNE_V(e)            BF_CPM_USBPCRXPREEMPHTUNE(BV_CPM_USBPCRXPREEMPHTUNE__##e)
#define BFM_CPM_USBPCRXPREEMPHTUNE_V(v)           BM_CPM_USBPCRXPREEMPHTUNE
...
#define BP_CPM_CLKGRCU            18
#define BM_CPM_CLKGRCU            0x40000
#define BF_CPM_CLKGRCU(v)         (((v) & 0x1) << 18)
#define BFM_CPM_CLKGRCU(v)        BM_CPM_CLKGRCU
#define BF_CPM_CLKGRCU_V(e)       BF_CPM_CLKGRCU(BV_CPM_CLKGRCU__##e)
#define BFM_CPM_CLKGRCU_V(v)      BM_CPM_CLKGRCU
